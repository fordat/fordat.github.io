    ...
    render() {
        return (
            <div className="info-wrapper">
                ...
                <p className="info">Currently, I'm at Fyrefish Technologies, working on designs and code for new products.  Previously, I was a laboratory manager, researcher, and developer at the <a className="wlink" href="https://viscoglab.psych.ubc.ca/">UBC Visual Cognition Lab</a>, where I got to work on problems relating to cognitive science, perception, and data visualization.</p>
