    ...
    render() {
        return (
            <div className="info-wrapper">
                ...
                <p className="info">Currently, I'm a Frontend Developer at PhoneBox, a wireless network provider. I'm proficient in TypeScript and Node.js and have extensive experience working with the MERN stack for web development and React Native / Expo for mobile.</p>
