    ...
    render() {
        return (
            <div className="info-wrapper">
                ...
                <p className="info">I'm a researcher and developer working out of Vancouver, BC.</p>
                ...
                <p className="info">In my free time, I like to cook, paint, play the piano, go on walks, and work on my bicycle.</p>
            </div>
        )
    }
}
