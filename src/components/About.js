    ...
    render() {
        return (
            <div className="info-wrapper">
                ...
                <p className="info">Currently, I'm at UVX Inc., a healthcare technology start-up. I'm proficient with TypeScript and Node.js and have extensive experience working with the MERN stack for web development and React Native / Expo for mobile. My other programming interests are graphics, computer vision, and game development.</p>
